...
<div {{ $attributes->merge(['class' => 'relative']) }}>
    <form action="{{ $route }}" method="GET">
        <div class="flex items-center">
            ...
            <button type="submit" class="ml-2 inline-flex items-center px-4 py-2 bg-gray-600 dark:bg-gray-500 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:focus:ring-offset-slate-800 transition duration-300 ease-in-out">
