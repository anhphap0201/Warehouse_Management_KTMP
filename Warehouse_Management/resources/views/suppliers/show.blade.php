                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex justify-between">
                                    <span class="font-medium date-label">Ngày tạo:</span>
                                    <span class="created-date">{{ $supplier->created_at->format('d/m/Y H:i:s') }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="font-medium date-label">Cập nhật lần cuối:</span>
                                    <span class="updated-date">{{ $supplier->updated_at->format('d/m/Y H:i:s') }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                                    ...
                                    <tbody class="bg-transparent dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-600">
